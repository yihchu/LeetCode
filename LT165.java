public class LT165 {
    ...
    public static void main(String[] args) {
        LT165 lt165 = new LT165();
        System.out.println(lt165.compareVersion("1.01", "1.001")); // 0
        System.out.println(lt165.compareVersion("1.0", "1.0.0")); // 0
        System.out.println(lt165.compareVersion("0.1", "1.1")); // -1
        System.out.println(lt165.compareVersion("1.0.1", "1")); // 1
        System.out.println(lt165.compareVersion("7.5.2.4", "7.5.3")); // -1
    }
}
