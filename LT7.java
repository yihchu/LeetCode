public class LT7 {
    ...
    public static void main(String[] args) {
        LT7 lt7 = new LT7();
        System.out.println(lt7.numWays(5, new int[][]{{0, 2}, {2, 1}, {3, 4}, {2, 3}, {1, 4}, {2, 0}, {0, 4}}, 3));
        System.out.println(lt7.numWays(3, new int[][]{{0, 2}, {2, 1}}, 2));
    }
...
输出：3
解释：信息从小A编号0处开始，经3轮传递，到达编号4。共有3种方案，分别是 0->2->0->4，0->2->1->4，0->2->3->4。
