...
public class LT138 {
    ...
    public static void main(String[] args) {
        LT138 lt138 = new LT138();
        show(lt138.copyRandomList(toList(new int[][]{{7, -1}, {13, 0}, {11, 4}, {10, 2}, {1, 0}})));
        show(lt138.copyRandomList(toList(new int[][]{{1, 1}, {2, 1}})));
        show(lt138.copyRandomList(toList(new int[][]{{3, -1}, {3, 0}, {3, -1}})));
        show(lt138.copyRandomList(toList(new int[][]{})));
    }
