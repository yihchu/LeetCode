...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        slt.findWords(new char[][]{{'o', 'a', 'a', 'n'}, {'e', 't', 'a', 'e'}, {'i', 'h', 'k', 'r'}, {'i', 'f', 'l', 'v'}}, new String[]{"oath", "pea", "eat", "rain"})
                .forEach(r -> System.out.print(r +" "));
        System.out.println();
        slt.findWords(new char[][]{{'a', 'b'}, {'c', 'd'}}, new String[]{"abcb"})
                .forEach(r -> System.out.print(r +" "));
        System.out.println();
        slt.findWords(
        ...
        slt.findWords(new char[][]{{'a'}, {'a'}}, new String[]{"aa"})
