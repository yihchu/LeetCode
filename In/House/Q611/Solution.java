...
//                        System.out.println("(" + nums[i] + ", " + nums[j] + ", " + nums[k] + ") -> " + (map.get(nums[i]) * map.get(nums[j]) * map.get(nums[k])));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(slt.triangleNumber(
        ...
        for (int i = 0; i < times; ++i) {
            slt.triangleNumberV1(new int[]{0, 1, 1}); // 0
            slt.triangleNumberV1(new int[]{2, 2, 3, 4}); // 3
            slt.triangleNumberV1(new int[]{4, 2, 3, 4}); // 4
            slt.triangleNumberV1(new int[]{4, 2, 3, 4, 3, 4, 4}); // 35
            slt.triangleNumber(
                    new int[]{148, 2, 318, 845, 899, 489, 741, 921, 693, 616, 87, 464, 360, 217, 116, 443, 543, 485, 937
                            , 965, 791, 779, 187, 787, 344, 431, 398, 427, 752, 374, 414, 388, 441, 821, 852, 770, 989, 43
                            , 811, 757, 449, 832, 384, 834, 616, 271, 610, 408, 521, 252, 10, 670, 889, 200, 531, 214, 830
        ...
        for (int i = 0; i < times; ++i) {
            slt.triangleNumber(new int[]{0, 1, 1}); // 0
            slt.triangleNumber(new int[]{2, 2, 3, 4}); // 3
            slt.triangleNumber(new int[]{4, 2, 3, 4}); // 4
            slt.triangleNumber(new int[]{4, 2, 3, 4, 3, 4, 4}); // 35
            slt.triangleNumber(
                    new int[]{148, 2, 318, 845, 899, 489, 741, 921, 693, 616, 87, 464, 360, 217, 116, 443, 543, 485, 937
                            , 965, 791, 779, 187, 787, 344, 431, 398, 427, 752, 374, 414, 388, 441, 821, 852, 770, 989, 43
                            , 811, 757, 449, 832, 384, 834, 616, 271, 610, 408, 521, 252, 10, 670, 889, 200, 531, 214, 830
