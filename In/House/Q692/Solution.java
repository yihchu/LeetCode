...
//        }
    ...
    public static void main(String[] args) {
        ...
        slt.topKFrequent(new String[]{"i", "love", "leetcode", "i", "love", "coding"}, 2)
                .forEach(s -> System.out.print(s + " "));
        System.out.println();
        slt.topKFrequent(new String[]{"the", "day", "is", "sunny", "the", "the", "the", "sunny", "is", "is"}, 4)
                .forEach(s -> System.out.print(s + " "));
        System.out.println();
        slt.topKFrequent(new String[]{"glarko", "zlfiwwb", "nsfspyox", "pwqvwmlgri", "qggx", "qrkgmliewc", "zskaqzwo"
                ...
                .forEach(s -> System.out.print(s + " "));
        System.out.println();
        slt.topKFrequent(new String[]{"rmrypv", "zgsedk", "jlmetsplg", "wnfbo", "hnnftqf", "bxlr", "sviavwoxss",
