...
public class LT2 {
    ...
    public static void main(String[] args) {
        LT2 lt2 = new LT2();
        lt2.addTwoNumbers(toList(new int[] {2, 4, 3}), toList(new int[] {5, 6, 4})).print();
        lt2.addTwoNumbers(toList(new int[] {0}), toList(new int[] {0})).print();
        lt2.addTwoNumbers(toList(new int[] {9, 9, 9, 9, 9, 9, 9}), toList(new int[] {9, 9, 9, 9})).print();
    }
