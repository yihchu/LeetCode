...
//    }
    ...
    public static void main(String[] args) {
        LT552 lt552 = new LT552();
        System.out.println(lt552.checkRecord(1)); // 3
        System.out.println(lt552.checkRecord(2)); // 8
        System.out.println(lt552.checkRecord(3)); // 19
        System.out.println(lt552.checkRecord(4)); // 43
        System.out.println(lt552.checkRecord(5)); // 94
        System.out.println(lt552.checkRecord(10101)); // 183236316
        System.out.println(lt552.checkRecord(100000)); // 749184020
    }
...
只有"AA"不会被视为可奖励，因为缺勤次数为2次（需要少于 2 次）。
