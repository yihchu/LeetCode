...
public class LT1846 {
    ...
    public static void main(String[] args) {
        LT1846 lt1846 = new LT1846();
        System.out.println(lt1846.maximumElementAfterDecrementingAndRearranging(new int[]{2, 2, 1, 2, 1})); // 2
        System.out.println(lt1846.maximumElementAfterDecrementingAndRearranging(new int[]{100, 1, 1000})); // 3
        System.out.println(lt1846.maximumElementAfterDecrementingAndRearranging(new int[]{1, 2, 3, 4, 5})); // 5
        System.out.println(lt1846.maximumElementAfterDecrementingAndRearranging(new int[]{73, 98, 9})); // 3
        System.out.println(lt1846.maximumElementAfterDecrementingAndRearranging(new int[]{
