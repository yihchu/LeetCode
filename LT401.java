...
public class LT401 {
    ...
    public static void main(String[] args) {
        LT401 lt401 = new LT401();
        System.out.println(">>>>>>>>>>>>>>>>>>>>");
        System.out.println("--------------------");
        System.out.println(">>>>> turned = 0: ");
        lt401.readBinaryWatch(0).stream().forEach(s -> System.out.print(s + " "));
        System.out.println();
        System.out.println("--------------------");
        System.out.println(">>>>> turned = 1: ");
        lt401.readBinaryWatch(1).stream().forEach(s -> System.out.print(s + " "));
        System.out.println();
        System.out.println("--------------------");
        ...
        lt401.readBinaryWatch(2).stream().forEach(s -> System.out.print(s + " "));
        System.out.println();
        System.out.println("--------------------");
        System.out.println(">>>>> turned = 9: ");
        lt401.readBinaryWatch(9).stream().forEach(s -> System.out.print(s + " "));
        System.out.println();
        System.out.println("--------------------");
        System.out.println("<<<<<<<<<<<<<<<<<<<<");
    }
