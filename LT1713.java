...
//    }
    ...
    public static void main(String[] args) {
        LT1713 lt1713 = new LT1713();
        System.out.println(lt1713.minOperations(new int[]{5, 1, 3}, new int[]{9, 4, 2, 3, 4})); // 2
        System.out.println(lt1713.minOperations(new int[]{6, 4, 8, 1, 3, 2}, new int[]{4, 7, 6, 2, 3, 8, 6, 1})); // 3
        System.out.println(lt1713.minOperations(new int[]{16, 7, 20, 11, 15, 13, 10, 14, 6, 8}, new int[]{11, 14, 15, 7, 5, 5, 6, 10, 11, 6})); // 6
        System.out.println(lt1713.minOperations(new int[]{1, 3, 8}, new int[]{2, 6})); // 3
    }
