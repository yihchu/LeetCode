...
public class LT524 {
    ...
    public static void main(String[] args) {
        LT524 lt524 = new LT524();
        System.out.println(lt524.findLongestWord("abpcplea", Arrays.asList("ale", "apple", "monkey", "plea"))); // apple
        System.out.println(lt524.findLongestWord("abpcplea", Arrays.asList("a", "b", "c"))); // a
    }
