public class LT273 {
    ...
    public static void main(String[] args) {
        LT273 lt273 = new LT273();
        System.out.println("*" + lt273.numberToWords(0) + "*"); // "Zero"
        System.out.println("*" + lt273.numberToWords(123) + "*"); // "One Hundred Twenty Three"
        System.out.println("*" + lt273.numberToWords(12345) + "*"); // "Twelve Thousand Three Hundred Forty Five"
        // "One Million Two Hundred Thirty Four Thousand Five Hundred Sixty Seven"
        System.out.println("*" + lt273.numberToWords(1234567) + "*");
        // "One Billion Two Hundred Thirty Four Million Five Hundred Sixty Seven Thousand Eight Hundred Ninety One"
        System.out.println("*" + lt273.numberToWords(1234567891) + "*");
        // "Two Billion One Hundred Forty Seven Million Four Hundred Eighty Three Thousand Six Hundred Forty Seven"
        System.out.println("*" + lt273.numberToWords(2147483647) + "*");
        System.out.println("*" + lt273.numberToWords(1000000) + "*"); // "One Million"
        System.out.println("*" + lt273.numberToWords(1000010) + "*"); // "One Million Ten"
    }
