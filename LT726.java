...
public class LT726 {
    ...
    public static void main(String[] args) {
        ...
        LT726 lt726 = new LT726();
        for (int i = 0; i < 1000; ++i) {
            System.out.println(">>>>> H2O -> " + lt726.countOfAtoms("H2O"));
            System.out.println(">>>>> Mg(OH)2 -> " + lt726.countOfAtoms("Mg(OH)2"));
            System.out.println(">>>>> K4(ON(SO3)2)2 -> " + lt726.countOfAtoms("K4(ON(SO3)2)2"));
        }
