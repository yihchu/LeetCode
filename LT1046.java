public class LT1046 {
    ...
    public static void main(String[] args) {
        LT1046 lt1046 = new LT1046();
        System.out.println(lt1046.lastStoneWeight(new int[]{2, 7, 4, 1, 8, 1})); // 1
        System.out.println(lt1046.lastStoneWeight(new int[]{2, 2})); // 0
        System.out.println(lt1046.lastStoneWeight(new int[]{9, 10, 1, 7, 3})); // 2
        System.out.println(lt1046.lastStoneWeight(new int[]{2, 6, 3, 9, 9, 3, 8})); //0
        System.out.println(lt1046.lastStoneWeight(new int[]{4, 3, 4, 3, 2})); // 2
    }
