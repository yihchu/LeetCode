...
public class LT1738 {
    ...
    public static void main(String[] args) {
        LT1738 lt1738 = new LT1738();
        System.out.println(lt1738.kthLargestValue(new int[][]{{5, 2}, {1, 6}}, 1)); // 7
        System.out.println(lt1738.kthLargestValue(new int[][]{{5, 2}, {1, 6}}, 2)); // 5
        System.out.println(lt1738.kthLargestValue(new int[][]{{5, 2}, {1, 6}}, 3)); // 4
        System.out.println(lt1738.kthLargestValue(new int[][]{{5, 2}, {1, 6}}, 4)); // 0
    }
