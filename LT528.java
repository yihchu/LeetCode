...
//    public Solution(int[] w) {
    ...
    public static void main(String[] args) {
        LT528 lt528 = null;
        lt528 = new LT528(new int[]{1});
        System.out.println(lt528.pickIndex());
        lt528 = new LT528(new int[]{1, 3});
        System.out.print(lt528.pickIndex() + " ");
        System.out.print(lt528.pickIndex() + " ");
        System.out.print(lt528.pickIndex() + " ");
        System.out.print(lt528.pickIndex() + " ");
        System.out.println(lt528.pickIndex());
...
solution.pickIndex(); // 返回 0，因为数组中只有一个元素，所以唯一的选择是返回下标0。
