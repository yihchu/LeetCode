...
//    public FizzBuzz(int n) {
    ...
    public static void main(String[] args) {
        LT1195 lt1195 = new LT1195(100);

        Thread fizz = new Thread(() -> {
            try {
                lt1195.fizz(() -> System.out.print("fizz, "));
        ...
        Thread buzz = new Thread(() -> {
            try {
                lt1195.buzz(() -> System.out.print("buzz, "));
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        });
        Thread fizzbuzz = new Thread(() -> {
            try {
                lt1195.fizzbuzz(() -> System.out.print("fizzbuzz, "));
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        });
        Thread number = new Thread(() -> {
            try {
                lt1195.number((x) -> System.out.print(x + ", "));
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
        });
